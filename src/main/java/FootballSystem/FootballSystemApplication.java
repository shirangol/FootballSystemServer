...
public class FootballSystemApplication {
	...
	public static void main(String[] args) throws UserNameAlreadyExistException, NotHisTeamException, HasTeamAlreadyException, TeamIsClosedException, NotOwnerOfThisTeamException, LeagueNameAlreadyExist, MustHaveLeastTwoTeams, MustHaveLeastOneMainReferee, MustHaveLeastTwoSideReferee, CantSchedulingRefereeWithoutGames, NoSuchAUserNamedException, WrongPasswordException {
